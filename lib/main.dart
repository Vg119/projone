...
void main() {
  //entry point of app , not in any class
  runApp(VxState(
      store: Mystore(),
      child: MyApp())); //alternative to perform cart operation
}
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      ...
      //taking theme from themes.dart (Mytheme class)
      initialRoute: Myroutes.homepg2,
      //setting initialroute to "/home" , by default set to "/"
      routes: {
        //these are named routes , i.e used with Navigation.pushnamed
        Myroutes.login: (context) => Loginpage(),
        // writing new LoginPage and LoginPage is same .
