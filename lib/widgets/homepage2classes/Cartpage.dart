...
class Cartpage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        children: [
          Cartlist().px32().expand(),
          //a widget that is used to hold space for a widget that will be made in the future
          Divider(),
          _Carttotal(),
        ],
      ),
      ...
      child: Row(
        ...
        children: [
          "\$${_cart.totalPrice()}"
              ...
              .make(), //displays total price
          100.widthBox,
          ElevatedButton(
                  onPressed: () {
                    ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        content: "Buyimg not supported"
                            .text
                            .make())); //scaffoldmessenger shows snackbar at bottom and top of screen
                  },
                  style: ButtonStyle(
                      backgroundColor:
...
class Cartlist extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _cart.cartitems.isEmpty
        ? ("Empty cart".text.xl5.make().centered())
        : ListView.builder(
            ...
            itemBuilder: (context, index) => ListTile(
                  ...
                  trailing: IconButton(
                    ...
                    onPressed:
                        () //on pressing - the item is removed from cartmodel 's list
                        {
                  ...
                  title: Text(_cart.cartitems[index]
                      .name), //to display each item of cart model
                ));
  }
}
